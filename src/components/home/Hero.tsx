  ...
  return (
    <section className="relative overflow-hidden min-h-screen flex items-center justify-center">
      ...
      <img
        src={ghost}
        alt="floating ghost"
        className="pointer-events-none absolute left-6 top-16 h-16 w-16 opacity-50 animate-fade-in"
      />
      <img
        src={ghost}
        alt="floating ghost"
        className="pointer-events-none absolute right-10 top-28 h-20 w-20 opacity-40 animate-fade-in"
      />
      <img
        src={ghost}
        alt="floating ghost"
        className="pointer-events-none absolute left-1/3 bottom-10 h-14 w-14 opacity-40 animate-fade-in"
      />
      ...
      <div className="container relative">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex items-center justify-center gap-3">
            ...
            <a href="#about" className="story-link text-sm">
              Learn our origin story
            </a>
          </div>
        </div>
      </div>
